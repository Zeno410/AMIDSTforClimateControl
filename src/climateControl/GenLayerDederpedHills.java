...
public class GenLayerDederpedHills extends GenLayer{
    private GenLayer field_151628_d;
    private static final String __OBFID = "CL_00000563";

    public GenLayerDederpedHills(long p_i45479_1_, GenLayer p_i45479_3_, GenLayer p_i45479_4_)
    {
        super(p_i45479_1_);
        ...
        for (int i1 = 0; i1 < par4; ++i1)
        {
            for (int j1 = 0; j1 < par3; ++j1)
            {
                ...
                else
                {
                    ...
                    else if (k1 == BiomeGenBase.ocean.biomeID && this.nextInt(6) == 0)
                    {
                        j2 = this.nextInt(2);
