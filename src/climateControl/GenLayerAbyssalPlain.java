...
/**
 *
 * Serves the function of GenLayerDeepOcean but puts in the height value for deep ocean
 * rather than the biome code
 * @author Zeno410
 */
public class GenLayerAbyssalPlain extends GenLayer
{
    private static final String __OBFID = "CL_00000546";

    public GenLayerAbyssalPlain(long p_i45472_1_, GenLayer p_i45472_3_)
    {
        super(p_i45472_1_);
